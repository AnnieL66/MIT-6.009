...
class TestColorFilters(Lab1Test):
    ...
    def test_color_filter_inverted_2(self):
        ...
        color_inverted = lab.color_filter_from_greyscale_filter(lab.inverted)
        result = color_inverted(im)
        lab.save_color_image(result, '/Users/yaxinliu/Downloads/lab1/ColorFilterInverted.png')
    ...
    def test_blur_filter_2(self):
        ...
        result = color_blur(im)
        lab.save_color_image(result, '/Users/yaxinliu/Downloads/lab1/Make_Blurred.png')
    ...
    def test_sharpen_filters_1(self):
        ...
        self.assertTrue(callable(sharpen_filter), 'make_sharpen_filter should return a function.')
        color_sharpen = lab.color_filter_from_greyscale_filter(sharpen_filter)
        im = lab.load_color_image('test_images/sparrowchick.png')
        result = color_sharpen(im)
        lab.save_color_image(result, '/Users/yaxinliu/Downloads/lab1/Make_Sharpen.png')
...
class TestCascade(Lab1Test):
    ...
    def test_cascade_2(self):
        ...
        filter2 = lab.color_filter_from_greyscale_filter(lab.make_blur_filter(5))
        filt = lab.filter_cascade([filter1, filter1, filter2, filter1])
        result = filt(im)
        lab.save_color_image(result, '/Users/yaxinliu/Downloads/lab1/Cascade.png')
...
class TestSeamCarvingHelpers(Lab1Test):
    ...
    def test_min_seam_indices_1(self):
        im = {
            'height': 3,
            'width': 3,
            'pixels': [0, 0, 255,
        ...
        seam = [0,3, 6]
        result = lab.minimum_energy_seam(im)
        self.assertEqual(len(result), len(seam))
        self.assertEqual(set(result), set(seam))
...
class TestCreativeFilter(Lab1Test):
    def test_endtoend_centeredpixel(self):
        im = lab.load_color_image('test_images/centered_pixel.png')
        result = lab.threshold(im, 150, 170)
        lab.save_color_image(result, '/Users/yaxinliu/Downloads/lab1/CreativeFilter.png')
    
    def test_endtoend_centeredpixel_1(self):
        im = lab.load_color_image('test_images/centered_pixel.png')
        result = lab.threshold(im, 0, 255)
        lab.save_color_image(result, '/Users/yaxinliu/Downloads/lab1/CreativeFilter_1.png')

    def test_endtoend_centeredpixel_2(self):
        im = lab.load_color_image('test_images/chess.png')
        result = lab.threshold(im, 150, 170)
        lab.save_color_image(result, '/Users/yaxinliu/Downloads/lab1/CreativeFilte_2.png')
